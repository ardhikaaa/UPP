            ...
            <table class="w-full text-sm text-left text-[#142143]">
                ...
                <tbody class="divide-y divide-[#142143]/20">
                    ...
                    <tr class="hover:bg-[#142143]/5 transition duration-200">
                        ...
                        <td class="px-6 py-4 font-medium text-[#142143]">{{ $item->unit->unit }}</td>
                        <td class="px-6 py-4 font-medium text-[#142143]">{{ $item->kelas->kelas }}</td>
                        <td class="px-6 py-4 font-medium text-[#142143]">{{ $item->siswa->nama_siswa }}</td>
                        <td class="px-6 py-4">
                            <div class="flex items-center space-x-2">
                                <button 
                                    class="text-[#1a5d94] hover:text-[#142143] p-1 rounded-lg hover:bg-[#1a5d94]/10 transition duration-200 btn-edit-rombel"
                                    data-id="{{ $item->id }}"
